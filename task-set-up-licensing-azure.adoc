...
选择 Freemium 产品，免费使用 Cloud Volumes ONTAP，最多可使用 500 GiB 的已配置容量。link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["了解有关免费增值服务的更多信息"^]。
...
+
除非您已配置的容量超过 500 GiB，否则不会通过平台订阅向您收费，此时系统将自动转换为link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["基本套餐"^]。
...
NOTE: NetApp 已限制 BYOL 许可的购买、延期和续期。有关详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP的 BYOL 许可可用性受限"^]。
...
+
您的许可证必须在控制台上可用，然后才能与 Cloud Volumes ONTAP 配合使用。如有需要，您可以 link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["手动将许可证添加到控制台"]。
...
TIP: 您可以从"设置">"凭据"页面管理与 Azure 帐户关联的 Azure Marketplace 订阅。 https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["了解如何管理 Azure 帐户和订阅"^]
