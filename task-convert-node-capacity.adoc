...
* 许可证转换工具支持所有部署类型，例如单节点、单可用区 (AZ) 中的高可用性 (HA)、多个可用区中的 HA、自带许可证 (BYOL) 和 PAYGO。
...
由于私有模式不支持市场订阅，因此您需要从 NetApp 购买 Essentials 自带许可证或 BYOL 套餐。这样，您无需市场订阅，即可在 BYOL 模型中保留基于容量的许可的优势。
