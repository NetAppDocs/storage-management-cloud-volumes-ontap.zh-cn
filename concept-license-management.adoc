...
---
= 了解 Cloud Volumes ONTAP 基于节点的 BYOL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:concept-licensing.html["了解Cloud Volumes ONTAP许可证"]。

link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html["了解有关如何管理基于节点的许可证的更多信息"^]。
...
https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["了解如何将NetApp支持站点帐户添加到控制台"^]。
