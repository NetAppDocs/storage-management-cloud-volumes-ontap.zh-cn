...
.相关链接
* 有关 WORM 的更多信息，请参阅link:concept-worm.html["了解Cloud Volumes ONTAP上的 WORM 存储"]。
* 有关SnapLock卷的充电信息，请参阅link:concept-licensing-charging.html["Cloud Volumes ONTAP中的许可和计费"]。
