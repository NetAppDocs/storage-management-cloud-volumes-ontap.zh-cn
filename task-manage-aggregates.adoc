...
. 从系统详细信息中，单击“*聚合*”选项卡。
. 对于所需的聚合，单击管理操作的 image:icon-action.png["显示三个水平点的图标，用于其他操作"] 图标。
+
image:screenshot_aggr_menu_options.png["聚合菜单选项的屏幕截图。"]

. 通过 image:icon-action.png["显示三个水平点的图标，用于其他操作"] 菜单中的可用选项管理您的聚合。
...
. 在 image:icon-action.png["显示三个水平点的图标，用于其他操作"] 菜单下，单击*增加容量*。
