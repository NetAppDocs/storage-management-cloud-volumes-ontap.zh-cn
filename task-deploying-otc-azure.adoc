...
+
此选项仅适用于某些虚拟机类型。要了解支持哪些虚拟机类型，请参阅 link:link:reference-configs-azure.html#ha-pairs["HA 对许可证支持的配置"]。
...
+
link:link:reference-configs-azure.html#ha-pairs["详细了解 Azure 中支持的配置"^]。
