...
| *支持的虚拟机 (VM) 类型*  a| 
Eds_v5 和 Ls_v3 实例类型
| 全方位的虚拟机类型。 link:reference-configs-azure.html["Azure 中支持的配置"] 
...
| *支持的磁盘类型* | 高级 SSD v2 托管磁盘 | 更广泛的支持。 link:reference-configs-azure.html#azure-storage-for-user-data["Azure 中支持的磁盘类型"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["NetApp Console文档"^]
