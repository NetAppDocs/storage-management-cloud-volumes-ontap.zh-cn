...
您可以选择从云市场或通过 NetApp（自带许可证（BYOL））购买或续订许可证和订阅。市场为您提供年度订阅和现收现付（PAYGO）选项。有关信息，请参见 link:concept-license-management.html["了解有关Cloud Volumes ONTAP基于容量的许可证的更多信息"]。
