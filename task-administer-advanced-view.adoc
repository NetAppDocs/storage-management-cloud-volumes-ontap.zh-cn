...
.步骤
. 从左侧导航窗格转到*管理>代理*。
. 单击所需控制台代理的image:icon-action.png["显示三个水平点的图标，用于其他操作"]图标，然后选择*编辑控制台代理*。
...
* https://docs.netapp.com/us-en/ontap/concepts/introducing-ontap-interfaces-concept.html["ONTAP 用户界面"^]
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html["了解有关使用 ONTAP System Manager 进行集群管理的信息"^]
