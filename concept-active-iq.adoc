...
* 如果您尚未在 Console 中注册 NSS 帐户，请立即注册 NSS 帐户，然后 Digital Advisor UI 将会显示。有关说明，请参阅 https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["管理与组织或帐户关联的 NSS 凭据"]。
