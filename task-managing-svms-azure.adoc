...
要了解有关运行 Cloud Volumes ONTAP API 调用的信息，请参阅 https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["您的第一次 API 调用"^]。
...
.开始之前
Console 代理需要特定权限才能为 Cloud Volumes ONTAP 创建存储 VM。所需权限包含在 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp提供的政策"^]中。
...
.开始之前
Console 代理需要特定权限来管理 Cloud Volumes ONTAP 的存储 VM。所需权限包含在 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp提供的政策"^]中。
