...
** 确保已完成网络配置并为专用模式部署创建工作者池。请参阅 link:reference-networking-gcp.html#infrastructure-manager-configuration-in-private-mode-or-protected-environments["适用于专用模式部署的 Infrastructure Manager 配置"]。
...
[%collapsible]
====
指定  `--worker-pool` 参数以在私有模式部署中运行工具。有关工作池配置，请参阅 link:reference-networking-gcp.html#infrastructure-manager-configuration-in-private-mode-or-protected-environments["适用于专用模式部署的 Infrastructure Manager 配置"]。
