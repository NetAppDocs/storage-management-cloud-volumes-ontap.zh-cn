...
[%collapsible]
====
指定  `--worker-pool` 参数以在私有模式部署中运行该工具。有关工作池配置，请参阅 link:reference-networking-gcp.html#infrastructure-manager-configuration-for-private-mode-deployments["适用于专用模式部署的 Infrastructure Manager 配置"]。
