...
---
= 在 Cloud Volumes ONTAP 中修改系统写入速度
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
所有类型的单节点系统和一些 HA 对配置均支持高写入速度。在 https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/["Cloud Volumes ONTAP发行说明"^]中查看支持的配置
