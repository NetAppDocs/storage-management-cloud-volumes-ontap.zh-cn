...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^] （也称为 Digital Advisor）已集成到 NetApp Console 中，以便您可以在单一管理平台中优化 Cloud Volumes ONTAP 系统的操作、安全性和性能。
