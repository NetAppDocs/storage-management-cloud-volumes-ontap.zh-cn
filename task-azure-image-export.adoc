...
----
+
URL 遵循标准格式。对于自动化，您可以导出 URL 字符串，如下所示。或者，您可以使用 Azure CLI `az` 命令获取 URL。示例 URL：+https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
