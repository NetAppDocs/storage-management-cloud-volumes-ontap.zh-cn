...
. https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["将您的NetApp支持站点帐户添加到NetApp Console"^]
+
...
TIP: 您可以从"设置" > "凭据"页面管理与您的帐户关联的 Google Cloud Marketplace 订阅。 https://docs.netapp.com/us-en/console-setup-admin/task-adding-gcp-accounts.html["了解如何管理您的 Google Cloud 凭据和订阅"^]
