...
.步骤
. 如果您在系统上启用了备份和恢复功能，请确定是否仍然需要备份的数据，然后…… https://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-backup-manage.html#delete-backups["如有必要，删除备份"^] 。
+
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["了解有关数据分类实例的更多信息"^]。

. 删除Cloud Volumes ONTAP系统。
+
.. 在“*系统*”页面上，双击要删除的Cloud Volumes ONTAP系统的名称。
.. 在控制台右上角，单击 image:icon-action.png["显示三个水平点的图标，用于其他操作"] 图标，然后选择 *Delete*。
