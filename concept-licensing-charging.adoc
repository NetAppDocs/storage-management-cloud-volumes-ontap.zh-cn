...
有关定价的详细信息，请转到 link:https://www.netapp.com/pricing/["NetApp 定价网站"^]。
...
通过基于容量的许可，Cloud Volumes ONTAP 系统的最大数量限制为每个 NetApp Console 组织 24 个。_系统_是 Cloud Volumes ONTAP HA 对、Cloud Volumes ONTAP 单节点系统或您创建的任何其他存储 VM。默认存储 VM 不计入限制。此限制适用于所有许可模式。
