...
* 如果您拥有 BYOL 许可证和来自市场的年度合同，我们将根据您设置的账单偏好向您收取消费和超额费用。要了解如何收取费用，请参阅link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["计费偏好和超额费用"]。
