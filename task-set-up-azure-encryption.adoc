...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["查看最新的权限列表"^]

.步骤
. 使用以下 API 调用获取 Azure 订阅中的密钥保管库列表。
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["对于 HA 对"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["对于单个节点"^]: `GET /azure/vsa/metadata/vaults`
...
+
对于 HA 对： `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
对于单个节点： `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. 对于 HA 对，请使用 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["此 API 调用"^]：
+
...
.. 对于单节点系统，请使用 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["此 API 调用"^]：
+
...
.相关链接
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["准备使用 Cloud Volumes ONTAP API 工作流程"^].
