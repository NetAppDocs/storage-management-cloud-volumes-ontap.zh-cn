...
summary: 了解 Cloud Volumes ONTAP 管理中的新增功能和增强功能。 
---
...
Cloud Volumes ONTAP 现在支持与 link:https://learn.microsoft.com/en-us/fabric/onelake/onelake-overview["Microsoft OneLake"^] 集成（公共预览版）。您可以使用 link:https://learn.microsoft.com/en-us/fabric/onelake/onelake-overview["Microsoft OneLake"^] 将 Cloud Volumes ONTAP 与 link:https://community.fabric.microsoft.com/["Microsoft Fabric"^] 集成，从而使现有的 Cloud Volumes ONTAP NAS 数据可用于 Microsoft 分析和 AI 服务，例如 Power BI、Azure AI Search、OpenAI 和 Microsoft Copilot。此集成不需要进行数据移动或复制。该集成使用 link:https://docs.netapp.com/us-en/ontap/s3-multiprotocol/index.html["ONTAP S3 多协议"^] 访问将 Cloud Volumes ONTAP 连接到现有的 Microsoft Fabric lakehouse。
...
.相关链接
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-azure.html["在 Azure 中使用快速创建部署 Cloud Volumes ONTAP"^]
...
从 2026 年 2 月 25 日起，Cloud Volumes ONTAP 将使用 Infrastructure Manager 进行新的和现有的私有模式部署。下表介绍了基本工作流程：
...
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-private-mode.html["私有模式部署快速入门"^]


|===
在专用模式部署中，您需要对 Cloud Volumes ONTAP 进行一些配置更改，才能开始使用 Infrastructure Manager。请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#infrastructure-manager-configuration-for-private-mode-deployments["适用于专用模式部署的 Infrastructure Manager 配置"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-perf-params-azure.html["在 Azure 中管理Cloud Volumes ONTAP的 Premium SSD v2 磁盘性能"^]。
...
对于 Cloud Volumes ONTAP 市场年度合同/私人优惠，Essentials 许可证的超额计算现在与 Bring-Your-Own License (BYOL) 套餐保持一致。此前，超额部分按精确的 Essentials 套餐的每小时市场费率收费。现在，如果您的市场年度合同包含多个 Essentials 套餐，NetApp Console 将根据订阅中价格较高的 Essentials 套餐的可用容量收取 Essentials 套餐的超额费用。这简化了 Essentials 套餐的超额计算，并确保从 BYOL 许可顺利过渡到基于订阅的模式。
...
有关详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-client-protocols.html#nvme-tcp["Cloud Volumes ONTAP支持的客户端协议：NVMe-TCP"^]。
...
有关详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-aws.html["使用快速部署在 AWS 中部署Cloud Volumes ONTAP"^]。
...
要了解有关许可包的信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Cloud Volumes ONTAP许可"^]。

有关切换到其他收费方式的信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["管理基于容量的许可"^]。
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-aws.html#network-configurations-to-support-connector-proxy-servers["用于支持 AWS 中的连接器代理的网络配置"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/azure/reference-networking-azure.html#network-configurations-to-support-connector["用于支持 Azure 中的连接器代理的网络配置"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#network-configurations-to-support-connector-proxy["用于支持 Google Cloud 中的连接器代理的网络配置"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-cvo-azure-mktplc.html["从 Azure 市场部署Cloud Volumes ONTAP"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html["在 Google Cloud 中管理Cloud Volumes ONTAP的数据服务存储虚拟机"^]
...
=== 已为 Cloud Volumes ONTAP 9.14.1 启用私有模式部署
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-azure.html["管理 Azure 中Cloud Volumes ONTAP的数据服务存储虚拟机"^]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-azure-mktplace-direct.html["了解 Azure 中的Cloud Volumes ONTAP部署选项"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-cvo-azure-mktplc.html["从 Azure 市场部署Cloud Volumes ONTAP"^]
...
link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-administer-advanced-view.html["使用系统管理器管理Cloud Volumes ONTAP"^]。
...
link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["管理基于容量的许可证"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#end-of-availability-of-node-based-licenses["基于节点的许可证的可用性终止"^] https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html["将Cloud Volumes ONTAP基于节点的许可证转换为基于容量的许可证"^]
...
* 如果您拥有有效、未过期的按节点划分的 Bring-Your-Own License (BYOL) 套餐
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-data-tiering.html#data-tiering-in-azure["Azure 中的数据分层"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-azure.html#security-group-rules["安全组规则"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html#enabling-worm-on-a-cloud-volumes-ontap-working-environment["在Cloud Volumes ONTAP工作环境中启用 WORM"^]
...
有关使用 HA 部署的 AWS 本地区域的更多信息，请参阅 link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones["AWS 本地区域"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-updating-ontap-cloud.html#upgrade-from-console-notifications["升级Cloud Volumes ONTAP软件"]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html["为Cloud Volumes ONTAP启用NetApp勒索软件防护解决方案"]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["WORM存储"]
...
此版本包括以下 Azure 功能和增强功能。请继续阅读，详细了解支持这些新功能的特定配置。



[[support-for-premium-ssd-v2-managed-disks-in-azure]]
=== Azure 中对高级 SSD v2 托管磁盘的支持

Azure 上的 Cloud Volumes ONTAP 系统现在支持高级 SSD v2 托管磁盘。与高级 SSD 托管磁盘相比，这些高级磁盘以更低的成本为单节点和高可用性 (HA) 对提供更高的性能和更低的延迟。与其他托管磁盘一样，最大磁盘大小为 32 TiB。可以配置高级 SSD v2 托管磁盘的性能（容量、吞吐量和 IOPS），从而使工作负载具有成本效益，同时满足不断变化的性能需求。



[[deploy-ha-pairs-in-single-availability-zones-in-azure]]
=== 在 Azure 中的单个可用区域中部署 HA 对

从 Cloud Volumes ONTAP 9.15.1 开始，您可以在 Azure 的单个可用区 (AZ) 中以 HA 模式部署虚拟机 (VM) 实例。与以前的非区域部署不同，Cloud Volumes ONTAP 9.15.1 在灵活业务流程模式下使用 Microsoft Virtual Machines Scale Sets 来部署所有资源，包括同一 AZ 内的独立故障域，从而确保最佳可用性。默认情况下，当满足以下条件时，此部署模式使用高级 SSD v2 托管磁盘：

* Cloud Volumes ONTAP的版本为 9.15.1 或更高版本。
* 所选区域和可用区支持 Premium SSD v2 托管磁盘。有关支持区域的信息，请参阅 https://azure.microsoft.com/en-us/explore/global-infrastructure/products-by-region/["Microsoft Azure 网站：按地区提供的产品"^]。要了解如何添加，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploying-otc-azure.html#launching-a-cloud-volumes-ontap-ha-pair-in-azure["在 Azure 中启动 Cloud Volumes ONTAP HA 对"^]。
* 该订阅已注册 Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD` 功能。https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-saz-feature.html["了解如何为单个可用区启用 VMOrchestratorZonalMultiFD"^]。


如果未满足上述任一标准，则先前用于本地冗余存储 (LRS) 的非区域部署模式将生效。



[[support-for-virtual-machines-scale-sets-to-unify-all-azure-ha-types]]
=== 支持虚拟机规模集以统一所有 Azure HA 类型

Cloud Volumes ONTAP 9.15.1 利用 Azure 上灵活编排模式下的 Virtual Machines Scale Sets，在单个可用性区域中部署虚拟机 (VM) 实例，以实现高可用性 (HA) 对。它涵盖了 HA 模式的所有类型，包括页面 blob、LRS、区域冗余存储 (ZRS) 或多区域，以及 LRS 区域（单 AZ）。

* https://learn.microsoft.com/en-us/azure/virtual-machine-scale-sets/["Microsoft Azure 文档：Virtual Machine Scale Sets 文档"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha-azure.html["了解 Azure 中的高可用性对"^]。
...
从 Cloud Volumes ONTAP 9.15.1 开始，支持 FlexCache 回写作为在缓存中写入的备用操作模式。

有关此功能的详细信息，请参阅 ONTAP 文档 https://docs.netapp.com/us-en/ontap/flexcache-writeback/flexcache-write-back-overview.html["FlexCache 回写概述"^]。

有关 BlueXP 如何管理 FlexCache 卷的信息，请参阅 https://docs.netapp.com/us-en/console-volume-caching/index.html["BlueXP 卷缓存文档"^]。
...
要查看支持的配置，请参阅 https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-azure.html#single-node-systems["Azure 中支持的配置"^]。
...
有关使用 HA 部署的 AWS 本地区域的更多信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones["AWS 本地区域"^]。
...
如果安全策略要求，您可以将 EC2 实例配置为使用 IMDSv2。有关说明，请参阅 https://docs.netapp.com/us-en/console-setup-admin/task-require-imdsv2.html["用于管理现有连接器的BlueXP设置和管理文档"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-updating-ontap-cloud.html#patch-releases["升级Cloud Volumes ONTAP"^]
...
有关使用情况报告的详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html#download-usage-reports["下载使用情况报告"^]。
...
要了解有关 ARP 与 Cloud Volumes ONTAP 结合使用的更多信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html#autonomous-ransomware-protection["自主勒索软件防护"^]。
...
有关详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["管理基于容量的许可证"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["了解如何查看账户中已消耗的容量"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-volumes.html["了解有关查看已创建的FlexGroup卷的更多信息。"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-encrypting-volumes.html["了解如何使用NetApp加密解决方案加密卷"^]。
...
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-private-mode.html["在没有互联网访问的位置安装连接器"^]
* https://docs.netapp.com/us-en/console-setup-admin/task-logging-in.html["访问连接器上的BlueXP控制台"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#manage-byol-licenses["添加未分配的许可证"^]
...
有关如何配置放置组创建设置的详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-configure-placement-group-failure-aws.html#overview["为 AWS HA 单可用区配置置放群组创建"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html#provide-details-about-your-azure-private-dns["提供有关 Azure 专用 DNS 的详细信息"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["了解 WORM 存储。"^]
...
请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Cloud Volumes ONTAP许可"^]。
...
有关随 Cloud Volumes ONTAP 自动安装的 ONTAP 功能许可证的更多信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-default-configs.html["Cloud Volumes ONTAP的默认配置"^]。
...
有关详细信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-moving-resource-groups-azure.html["移动资源组"]。
...
有关此新功能的更多信息，请参阅 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html["设置Cloud Volumes ONTAP以在 Azure 中使用客户管理的密钥"]。
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["了解如何更改充电方式"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["了解有关这些许可包的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html["了解有关 AWS 弹性卷支持的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-administer-advanced-view.html["了解有关高级视图的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html["了解有关弹性卷支持的更多信息"]。
...
"ec2:ModifyVolume",
----
请务必为已添加到BlueXP的每组AWS凭据提供这些权限 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["查看最新的 AWS 连接器策略"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-aws-shared-vpc.html["了解如何在共享子网中部署 HA 对"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html["了解有关 Azure Private Link 与Cloud Volumes ONTAP连接的更多信息"]。
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html["了解如何在 Google Cloud 中为Cloud Volumes ONTAP创建数据服务存储虚拟机"]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["了解有关许可的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-storage-class-for-tiered-data["了解如何更改分层数据的存储类别"]。
...
您仍然可以通过在与 Cloud Volumes ONTAP 系统连接的 Web 浏览器中输入集群管理 IP 地址来连接到 System Manager https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connecting-to-otc.html["了解有关连接到系统管理器的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-create-volumes.html["了解如何在特定聚合上创建卷"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["了解有关Cloud Volumes ONTAP许可选项的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#exchange-unassigned-node-based-licenses["了解如何交换未分配的基于节点的许可证"]。
...
如果您对 Cloud Volumes ONTAP 使用 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["基于容量的许可证"^]，则不再对 FlexClone 卷所用的容量收费。
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-keystone.html["了解如何在BlueXP中开始使用Keystone订阅"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html["了解有关这些步骤的更多信息"]。
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["了解有关这些许可选项的更多信息"]。
...
一次写入、多次读取（WORM）存储不再处于预览阶段，现已可与 Cloud Volumes ONTAP 配合使用 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["了解有关 WORM 存储的更多信息"]。
...
从 9.9.1 版本开始，Cloud Volumes ONTAP 现在通过以下收费方式支持 m5dn.24xlarge 实例类型：PAYGO Premium、Bring-Your-Own License (BYOL) 和 Freemium。
...
----
请确保为已添加到 BlueXP 的每组 Azure 凭据提供这些权限 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["查看 Azure 的最新连接器策略"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html["了解有关使用 Azure Private Link 和Cloud Volumes ONTAP 的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-cooling-period-for-the-auto-tiering-policy["了解如何调整最短冷却时间。"]
...
请注意，Connector 需要新权限才能删除 Azure 快照。 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["查看 Azure 的最新连接器策略"^]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html["在 AWS 中调整系统大小"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-setting-up-kms.html["了解有关使用Cloud Volumes ONTAP设置 AWS KMS 的更多信息"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#requirements-for-cloud-volumes-ontap["详细了解 Google Cloud 中的 IP 地址要求"]。
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html["详细了解 Google Cloud 网络要求"]。
