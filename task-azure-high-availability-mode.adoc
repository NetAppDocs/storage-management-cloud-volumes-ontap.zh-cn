...
.步骤
具有 _Owner_ 权限的 Azure 用户可以从 Azure CLI 启用该功能。
...
.相关链接
. https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-ha-ports-overview["Microsoft Azure 文档：高可用性端口概述"^]
. https://learn.microsoft.com/en-us/cli/azure/get-started-with-azure-cli?view=azure-cli-latest["Microsoft Azure 文档：Azure CLI 入门"^]
