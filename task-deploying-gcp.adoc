...
+
详细了解  https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html#flash-cache-support["Flash Cache"^] 和 link:concept-write-speed.html["写入速度"]。
...
要创建即用即付的 Cloud Volumes ONTAP 系统，您需要选择一个与从 Google Cloud Marketplace 订阅 Cloud Volumes ONTAP 相关联的 Google Cloud 项目。请参阅 Console 设置文档： https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-gcp-accounts.html["将市场订阅与 Google Cloud 凭据关联"^]。
